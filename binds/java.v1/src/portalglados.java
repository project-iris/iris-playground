...
public class PortalGlados {
    ...
    public static void main(String args[]) throws IOException, InterruptedException, ClosedException {
        // Disable the logger
